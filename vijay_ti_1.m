...
clear all;
% tic;
I=imread('C:\Users\RASIKA\Documents\SWATIDATA\DATABASE1\IMAGE-1.jpg');

% I=imread('lena256.jpg');                    % to read the image
